...
// bool client::Parser::getConfigParam(s_info_param &info, int flags, int
// annexes, 									int start)
// {
...
// // const Location *Parser::find_location(const old_Server *server)
// // {
// // 	if (server == NULL) {
// // 		return NULL;
// // 	}
...
// void Parser::getParam(s_info_param &info, int param, const old_Server
// *server)
// {
// 	if (param & F_ROOT) {

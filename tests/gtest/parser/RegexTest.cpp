...
/*   Updated: 2024/11/15 11:42:19 by jbrousse         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
class regexFunctionTest : public ::testing::TestWithParam<std::tuple<std::string, int>>
{
};	
...
INSTANTIATE_TEST_SUITE_P(
	...
	::testing::Values(
		...
		std::make_tuple("505", IS_ERROR_CODE | IS_DIGIT | IS_HOSTNAME | IS_BODY_SIZE | IS_PORT),
		std::make_tuple("exemple.com", IS_HOSTNAME),
		std::make_tuple("8080", IS_PORT | IS_DIGIT | IS_BODY_SIZE | IS_HOSTNAME),
		...
		std::make_tuple("20349820349820394823049283049283409823409823409283409KB", IS_HOSTNAME)
	)	
);